node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u vorah -p Devsecops#1" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 423153df11a7  vorah/myapplication" //must change your name and tag no
        sh "docker push   vorah/myapplication"
  }
}
